<template>
  ...
  <transition name="sidebar-slide">
    <aside v-show="isOpen || isLgSize" :class="{ '!lg:hidden': isHome }"
      class="fixed inset-0 z-40 flex-none w-72 h-screen bg-base-200 border-r lg:(z-30 static h-auto overflow-y-visible  w-62 block)">
      ...
      <div class=" overflow-y-auto h-full max-w-2xs h-screen lg:fixed lg:mx-2 lg:w-62">
        <nav class="pt-2 px-1 pl-3  text-base lg:(pl-10 pt-9 text-sm pb-10 h-(screen-18))" aria-label="Docs navigation">
